...
package dev.north.fortyone.gradle.solidity.tasks

import dev.north.fortyone.gradle.solidity.EVMVersion
...
open class SolidityCompileTask @Inject constructor(
  ...
  @get:Input
  val dockerSolidityImage: Property<String> = objectFactory.property()
  ...
  fun compileSolidity() {
    source.forEach { contract ->
      ...
      val executableParts = dockerCommand.get().split(" ")
      ...
      options.add(dockerSolidityImage.get())
